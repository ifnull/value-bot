...
exports.sillyNameMaker = (req, res) => {
  ...
  function makeName (assistant) {
    ...
    // functions kill; kill -9 $(ps aux | grep [g]oogle-cloud | awk '{print $2}'); functions start; functions deploy sillyNameMaker --trigger-http; functions debug sillyNameMaker; functions inspect sillyNameMaker;
